...
import { Status, updateUFO, deleteUFO } from 'reducers/ufos';
...
class EditUFOModal extends Component {
  ...
  handleDelete = () => {
    const { ufo, onClose, deleteUFO } = this.props;
    ...
    return (
      ...
      >
        <Form hideRequiredMark>
          <RowM>
            <ColLabel span={3}>UFO ID</ColLabel>
            <ColContent span={6}>{ufo.ufoId}</ColContent>
          </RowM>

          <RowM>
            <ColLabel span={3}>ALIVE</ColLabel>
            <ColContent span={6}>{Status[ufo.alive]}</ColContent>
          </RowM>

          <RowM>
            <ColLabel span={3}>設置時間</ColLabel>
            <ColContent span={6}>
          ...
          <RowM>
            <ColLabel span={3}>最後連線時間</ColLabel>
            <ColContent span={6}>
          ...
          <RowM>
            ...
            <ColContent span={6}>
              <Button onClick={this.handleMapModalVisible}>查看位置</Button>
            </ColContent>
          </RowM>

          <RowM>
            <ColLabel span={3}>座標</ColLabel>
            <ColContent span={21}>
              <Row>
                <Col span={4}>
                  <span>緯度</span>
        ...
        {mapModalVisible && (
          <MapUFOModal ufo={ufo} onClose={this.handleMapModalVisible} />
        )}
      </Modal>
    );
  }
