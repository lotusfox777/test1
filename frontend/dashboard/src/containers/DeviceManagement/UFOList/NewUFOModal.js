    ...
    return (
      ...
      >
        <Form hideRequiredMark>
          <Row>
            <Col span={12}>
              <FormItem {...doubleFormItemLayout} label="UFO ID" colon={false}>
            ...
            <Col span={12}>
              <FormItem {...doubleFormItemLayout} label="經度" colon={false}>
          ...
          <Row>
            <Col span={12}>
              <FormItem {...doubleFormItemLayout} label="緯度" colon={false}>
          ...
          <Row>
            <FormItem {...singleFormItemLayout} label="備註" colon={false}>
