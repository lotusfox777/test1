...
(function(global, factory) {
  if (typeof module === 'object' && typeof module.exports === 'object') {
    ...
    define(['moment/moment.js'], factory);
  } else {
  ...
  var taiwan = {
    ...
    isValidDate: function(tYear, month, day) {
      return (
        ...
        month <= 12 &&
        day >= 1 &&
        day <= utils.monthLength(tYear, month)
      );
    },
    /**
  ...
  var makeDateFromStringAndFormat = function(config) {
    ...
    tokens.forEach(function(token) {
      var parsedInput = (getParseRegexForToken(token, config).exec(string) ||
        [])[0];
      if (parsedInput) {
